...
<div class="container mt-5">
    <div class="row">
        <div class="col-6">
            <?php FLasher::flash(); ?>
            <h3>Daftar Siswa</h3>
            <button type="button" class="btn btn-warning mb-2" data-toggle="modal" data-target="#modol">
                    Tambah Siswa
            </button>
 ...
 <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-warning mr-2" data-toggle="modal" data-target="#moll<?=$blog['id']?>">
                            Detail
                        </button>
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <input type="text" class="form-control" id="nama" value="<?= $blog['Gender']?>" name="nama" readonly>
                                </div>
                        ...
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-secondary mr-2" data-toggle="modal" data-target="#exampleModal<?=$blog['id']?>">
                            Ubah
                        </button>
                            ...
                            <a href="<?= BASE_URL; ?>/siswa/hapus/<?= $blog['id']?> " onclick="return confirm('Yakin?');" class="btn btn-warning mr-2">hapus</a>
