            ...
            <button type="button" class="btn btn-warning mb-2" data-toggle="modal" data-target="#modol">
                    Tambah Jurusan
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                Close
                                </button> <button type="submit" class="btn btn-secondary">Tambah Data</button>
                                </div>
                                </form>
                                </div>
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-secondary mr-2" data-toggle="modal" data-target="#exampleModal<?=$blog['id']?>">
                            ...
                            <a href="<?= BASE_URL; ?>/jurusan/hapus/<?= $blog['id']?> " onclick="return confirm('Yakin?');" class="btn btn-warning mr-2">hapus</a>
